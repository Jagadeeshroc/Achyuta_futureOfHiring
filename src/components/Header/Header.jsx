...
import { FiSearch, FiX, FiClock, FiUser, FiBell, FiMessageSquare, FiMenu, FiHash, FiPlusSquare } from 'react-icons/fi';
...
export default function JobbyNavbar() {
  ...
  const { globalUnreadMessages, unreadCounts } = useNotifications(); 

  const navItems = [
    { path: "/home", icon: <FaHome className="text-lime-950"/>, text: "Home" },
     { path: "/feeds", icon: <FiPlusSquare  className="text-lime-950"/>, text: "Feeds" },
        ...
        {notificationsCount > 0 && (
          ...
          <div className="relative group cursor-pointer ">
            ...
            <div className="hidden group-hover:flex flex-col absolute top-full right-0 bg-white shadow-md rounded-md mt-2 py-2 w-40 z-50">
              ...
              <Link to="/settings" className="px-4 py-2 hover:bg-gray-100  no-underline!">Settings</Link>
              <Link to="/premium" className="px-4 py-2 text-yellow-500 hover:bg-gray-100  no-underline!">Go Premium</Link>
