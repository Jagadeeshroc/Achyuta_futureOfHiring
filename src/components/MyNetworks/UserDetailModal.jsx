          ...
          <div className="p-8">
            <div className="text-center mb-6 p-2">
              ...
              {(user.company || user.location) && (
                <div className="flex flex-col gap-2 text-sm text-gray-500 m-2">
                  {user.company && (
              ...
              <div className="mb-6 p-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {user.skills.map((skill, i) => (
                    <span
                      key={i}
                      className="bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 px-3 py-1.5 rounded-full text-xs font-medium"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            {(user.email || user.phone) && (
              <div className="border-t p-2">
                ...
                <div className="flex flex-row "> 
                  <button className="mt-4 w-full bg-blue-600 py-1 px-3 rounded-lg! hover:bg-blue-700 transition-all duration-300 m-2  ">
