    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      >
        ...
        <motion.h1
          ...
          className="relative text-5xl font-extrabold z-10 tracking-wide"
        >
          Freelance Marketplace
        </motion.h1>
        <p className="relative text-xl mt-4 text-indigo-100 z-10 max-w-2xl text-center">
        ...
        <motion.button
          ...
          className="relative mt-6 px-8 py-3 bg-indigo-600 text-white font-semibold rounded-full shadow-lg hover:bg-indigo-700 transition-all z-10"
        >
          <FaPlus className="inline mr-2" /> Post a Job or Service
        </motion.button>
      </div>
      ...
      <div className="max-w-6xl mx-auto mt-16 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <FaBriefcase className="text-5xl text-indigo-600 mx-auto mb-4" />
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-xl p-6 text-center hover:shadow-2xl transition-shadow"
          >
            <FaTools className="text-5xl text-indigo-600 mx-auto mb-4" />
